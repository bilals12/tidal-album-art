import { MediaProduct, PlaybackContext } from '../interfaces';
...
export declare function mediaProductTransition(mediaProduct: MediaProduct, playbackContext: PlaybackContext): MediaProductTransition;
